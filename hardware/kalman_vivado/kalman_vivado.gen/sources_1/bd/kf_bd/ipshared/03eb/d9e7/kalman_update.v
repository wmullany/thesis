...
module kalman_update (
    ...
    */
    ...
    matrix_multiplication #(.rowsA(3'd4), .colsA(3'd6), .colsB(1)) mm1 (
    ...
    matrix_multiplication #(.rowsA(3'b110), .colsA(3'b100), .colsB(1)) mm2 (
    ...
    // 5) K * H (6x4 * 4x6 = 6x6)
    matrix_multiplication #(.rowsA(3'b110), .colsA(3'b100), .colsB(3'b110)) mm3 (
    ...
    matrix_multiplication #(.rowsA(3'b110), .colsA(3'b110), .colsB(3'b110)) mm4 (
