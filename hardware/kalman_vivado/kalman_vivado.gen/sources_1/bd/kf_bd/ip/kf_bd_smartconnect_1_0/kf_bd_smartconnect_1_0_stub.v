...
// Command     : write_verilog -force -mode synth_stub -rename_top kf_bd_smartconnect_1_0 -prefix
//               kf_bd_smartconnect_1_0_ kf_bd_smartconnect_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "kf_bd_smartconnect_1_0,bd_754d,{}" *) (* CORE_GENERATION_INFO = "kf_bd_smartconnect_1_0,bd_754d,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_754d,Vivado 2024.2" *) 
module kf_bd_smartconnect_1_0(aclk, aresetn, S00_AXI_araddr, S00_AXI_arlen, 
