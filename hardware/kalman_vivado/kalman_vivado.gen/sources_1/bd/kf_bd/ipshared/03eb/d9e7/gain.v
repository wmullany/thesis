...
module kalman_gain (
    ...
    */
    ...
    matrix_multiplication #(.rowsA(3'd6), .colsA(3'd6), .colsB(3'd4)) mm1 (
    ...
    matrix_multiplication #(.rowsA(3'd4), .colsA(3'd6), .colsB(3'd6)) mm2 (
    ...
    matrix_multiplication #(.rowsA(3'd4), .colsA(3'd6), .colsB(3'd4)) mm3 (
    ...
    (* keep_hierarchy = "yes" *)matrix_inverse inv_inst (
    ...
    matrix_multiplication #(.rowsA(3'd6), .colsA(3'd4), .colsB(3'd4)) mm4 (
