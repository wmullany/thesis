...
HD_PWD='C:/Users/mulla/Documents/thesis/hardware/kalman_vivado/kalman_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kf_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kf_bd_wrapper.tcl
