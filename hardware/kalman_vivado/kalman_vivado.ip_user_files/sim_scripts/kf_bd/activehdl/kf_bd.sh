...
#                script (type 'kf_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/mulla/Documents/thesis/hardware/kalman_vivado/kalman_vivado.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
