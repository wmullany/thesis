...
#
# Script generated by Vivado on Fri Jun 13 23:07:02 +1000 2025
...
#
# Usage        : kf_bd.sh
#                kf_bd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                kf_bd.sh [-reset_run]
#                kf_bd.sh [-reset_log]
#                kf_bd.sh [-help]
#
...
# script info
echo -e "kf_bd.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./kf_bd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L lib_pkg_v1_0_4 -L lib_cdc_v1_0_3 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_9 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_srl_fifo_v1_0_4 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_dma_v7_1_34 -L xlconstant_v1_1_9 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot kf_bd xil_defaultlib.kf_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim kf_bd -key {Behavioral:sim_1:Functional:kf_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/kf_bd.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kf_bd.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./kf_bd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: kf_bd.sh [-help]\n\
Usage: kf_bd.sh [-step]\n\
Usage: kf_bd.sh [-lib_map_path]\n\
Usage: kf_bd.sh [-reset_run]\n\
Usage: kf_bd.sh [-reset_log]\n\
Usage: kf_bd.sh [-keep_index]\n\
Usage: kf_bd.sh [-noclean_files]\n\n\
