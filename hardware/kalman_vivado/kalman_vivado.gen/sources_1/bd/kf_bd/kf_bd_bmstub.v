...
module kf_bd (
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SCL_I" *)
  (* X_INTERFACE_MODE = "master shield_i2c" *)
  input shield_i2c_scl_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SCL_O" *)
  output shield_i2c_scl_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SCL_T" *)
  output shield_i2c_scl_t;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SDA_I" *)
  input shield_i2c_sda_i;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SDA_O" *)
  output shield_i2c_sda_o;
  (* X_INTERFACE_INFO = "xilinx.com:interface:iic:1.0 shield_i2c SDA_T" *)
  output shield_i2c_sda_t;
