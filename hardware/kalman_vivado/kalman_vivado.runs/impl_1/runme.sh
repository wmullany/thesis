...
HD_PWD='C:/Users/mulla/Documents/thesis/hardware/kalman_vivado/kalman_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kf_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kf_bd_wrapper.tcl -notrace
