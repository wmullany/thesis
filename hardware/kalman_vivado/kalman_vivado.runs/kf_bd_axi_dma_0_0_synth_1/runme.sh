...
HD_PWD='C:/Users/mulla/Documents/thesis/hardware/kalman_vivado/kalman_vivado.runs/kf_bd_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kf_bd_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kf_bd_axi_dma_0_0.tcl
